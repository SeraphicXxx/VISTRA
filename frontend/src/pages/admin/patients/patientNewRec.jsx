    ...
    >
          ...
          <div>
            <div className="flex items-baseline gap-1">
              ...
              <div className="group relative flex items-center">
                <span className="cursor-help text-[11px] leading-none text-textMuted">
                  ⓘ
                </span>
                <div className="pointer-events-none absolute left-5 top-1/2 z-20 w-max -translate-y-1/2 rounded-lg bg-gray-900 px-3 py-2 text-xs text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100">
                  Format: 8 digits, dash, then a letter — e.g. 20230786-S
                </div>
              </div>
            </div>
            <input
              ...
              onChange={() => studentIdError && setStudentIdError("")}
              className={`w-full rounded-xl border bg-background px-3.5 py-2.5 text-sm text-textPrimary placeholder:text-textMuted transition-colors duration-200 focus:outline-none focus:ring-2 ${studentIdError ? "border-red-400 focus:border-red-400 focus:ring-red-200" : "border-border focus:border-primary/50 focus:ring-primary/20"}`}
            />
            {studentIdError && (
          ...
          <div>
            <div className="flex items-baseline gap-1">
              ...
              <div className="group relative flex items-center">
                ...
                <div className="pointer-events-none absolute left-5 top-1/2 z-20 w-max -translate-y-1/2 rounded-lg bg-gray-900 px-3 py-2 text-xs text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100">
                  Format: F, dash, year, dash, 3-digit no. — e.g. F-2023-045
                </div>
              </div>
            </div>
            <input
              ...
              onChange={() => facultyIdError && setFacultyIdError("")}
              className={`w-full rounded-xl border bg-background px-3.5 py-2.5 text-sm text-textPrimary placeholder:text-textMuted transition-colors duration-200 focus:outline-none focus:ring-2 ${facultyIdError ? "border-red-400 focus:border-red-400 focus:ring-red-200" : "border-border focus:border-primary/50 focus:ring-primary/20"}`}
            />
            {facultyIdError && (
              <p className="mt-1 text-xs text-red-500">{facultyIdError}</p>
            )}
          </div>
        )}
          ...
          <div>
            <div className="flex items-baseline gap-1">
              ...
              <div className="group relative flex items-center">
                ...
                <div className="pointer-events-none absolute left-5 top-1/2 z-20 w-max -translate-y-1/2 rounded-lg bg-gray-900 px-3 py-2 text-xs text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100">
                  Format: A, dash, year, dash, 3-digit no. — e.g. A-2023-045
                </div>
              </div>
            </div>
            <input
              ...
              onChange={() => adminIdError && setAdminIdError("")}
              className={`w-full rounded-xl border bg-background px-3.5 py-2.5 text-sm text-textPrimary placeholder:text-textMuted transition-colors duration-200 focus:outline-none focus:ring-2 ${adminIdError ? "border-red-400 focus:border-red-400 focus:ring-red-200" : "border-border focus:border-primary/50 focus:ring-primary/20"}`}
            />
            {adminIdError && (
              <p className="mt-1 text-xs text-red-500">{adminIdError}</p>
            )}
          </div>
        )}
      ...
      <div className="mt-8 border-t border-border pt-6">
       ...
       <div className="mt-6 flex items-start justify-center gap-1.5 text-center text-xs text-info">
        ...
        <span>
          Please ensure all information is accurate before saving. This record
          will be stored in the system for future reference.
        </span>
      </div>
