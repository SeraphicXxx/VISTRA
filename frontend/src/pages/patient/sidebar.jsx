...
import { PatientRoutes } from "/@/config/PatientRoutes.js";
  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 top-0 z-30 flex h-14 items-center justify-between border-b border-border bg-surface px-4 lg:hidden">
        <LogoClickable className="h-7" navigateTo={ROUTES.patient.dashboard.overview} />
        <button
          type="button"
          onClick={() => open()}
      ...
      >
        <div className="flex items-center justify-between gap-2.5 px-6 py-6">
          <LogoClickable className="h-8" navigateTo={ROUTES.patient.dashboard.overview} />
